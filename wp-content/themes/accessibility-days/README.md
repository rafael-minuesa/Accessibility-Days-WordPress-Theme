...
An accessible Theme called 'Accessibility Days' meant for hacking, with minimal CSS and web accessibility feaures, such as:
...
* Licensed under GPLv2 or later. :) You can reuse it to make something cool.